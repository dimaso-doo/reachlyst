...
const sections = [
  ...
  ["Subscriptions", "Paid plans are billed through Stripe according to the selected package and billing interval. Plan features, usage limits, seats, extension access, and pricing may vary by package and may change over time."],
  ["Trials and cancellation", "If a trial is offered, it may end automatically or require upgrade to continue using paid features. You can cancel a subscription according to the billing controls available in the product or Stripe customer portal."],
