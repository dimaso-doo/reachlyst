...
export default async function ExtensionPage() {
  ...
  return <div className={styles.page}>
    ...
    <section className={styles.extensionSetupGrid}>
      ...
      <Card className={styles.videoTutorial}><h2>Video tutorial</h2><div><span>Video placeholder</span></div><p>A short setup walkthrough will live here.</p></Card>
    </section>
  </div>;
}
