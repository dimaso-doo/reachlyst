...
export function ReachlystBetaLogo({
  ...
  return (
    <span className={`relative inline-flex w-fit items-start ${className}`}>
      ...
      <span className={`pointer-events-none absolute -right-2 -top-1 rounded-[4px] bg-red-600 px-1.5 py-0.5 text-[9px] font-semibold leading-none text-white shadow-[0_6px_14px_rgba(220,38,38,.22)] ${badgeClassName}`}>
        BETA
      </span>
    </span>
  );
